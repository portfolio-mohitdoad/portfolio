        ...
        <table className="table-responsive">
          <tbody>
            ...
            <tr className="table_row">
              <td rowSpan={2}>
                <div>
                  <img className="table_img" src={l1} alt="" />
                </div>
              </td>
              <td rowSpan={2}>
                <img className="table_img" src={l2} alt="" />
              </td>
            </tr>
            <tr></tr>
            <tr className="table_row">
              <td rowSpan={2}>
                <div>
                  <img className="table_img" src={l3} alt="" />
                </div>
              </td>
              <td rowSpan={2}>
                <img className="table_img" src={l4} alt="" />
              </td>
            </tr>
            <tr></tr>
            <tr className="table_row">
              <td rowSpan={2}>
                <div>
                  <img className="table_img" src={l5} alt="" />
                </div>
              </td>
              <td rowSpan={2}>
                <img className="table_img" src={l6} alt="" />
              </td>
            </tr>
            <tr></tr>
            <tr className="table_row">
              <td rowSpan={2}>
                <div>
                  <img className="table_img" src={l7} alt="" />
                </div>
              </td>
            </tr>
          </tbody>
        ...
        <table className="table-responsive2">
          <tbody>
            ...
            <tr className="table_row">
              <td colSpan={2}>
                <div>
                  <img className="table_img res_img" src={l1} alt="" />
                </div>
              </td>
            </tr>
            <tr className="table_row">
              <td colSpan={2}>
                <div>
                  <img className="table_img res_img" src={l2} alt="" />
                </div>
              </td>
            </tr>
            <tr className="table_row">
              <td colSpan={2}>
                <div>
                  <img className="table_img res_img" src={l3} alt="" />
                </div>
              </td>
            </tr>
            <tr className="table_row">
              <td colSpan={2}>
                <div>
                  <img className="table_img res_img" src={l4} alt="" />
                </div>
              </td>
            </tr>
            <tr className="table_row">
              <td colSpan={2}>
                <div>
                  <img className="table_img res_img" src={l5} alt="" />
                </div>
              </td>
            </tr>
            <tr className="table_row">
              <td colSpan={2}>
                <div>
                  <img className="table_img res_img" src={l6} alt="" />
                </div>
              </td>
            </tr>
            <tr className="table_row">
              <td colSpan={2}>
                <div>
                  <img className="table_img res_img" src={l7} alt="" />
                </div>
              </td>
            </tr>
          </tbody>
