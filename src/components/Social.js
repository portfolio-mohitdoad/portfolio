        ...
        <table>
          <tbody>
            ...
            <tr className="table_row">
              <td rowSpan={2}>
                <div>
                  <img className="table_img social_img" src={s10} alt="" />
                </div>
              </td>
            </tr>
            <tr></tr>
            <tr className="table_row">
              <td rowSpan={2}>
                <div>
                  <img className="table_img social_img" src={s5} alt="" />
                </div>
              </td>
            </tr>
            <tr></tr>
            <tr className="table_row">
              <td rowSpan={2}>
                <div>
                  <img className="table_img social_img" src={s11} alt="" />
                </div>
              </td>
            </tr>
            <tr></tr>
            <tr className="table_row">
              <td rowSpan={2}>
                <div>
                  <img className="table_img social_img" src={s3} alt="" />
                </div>
              </td>
            </tr>
            <tr></tr>
            <tr className="table_row">
              <td rowSpan={2}>
                <div>
                  <img className="table_img social_img" src={s6} alt="" />
                </div>
              </td>
            </tr>
            <tr></tr>
            <tr className="table_row">
              <td rowSpan={2}>
                <div>
                  <img className="table_img social_img" src={s2} alt="" />
                </div>
              </td>
            </tr>
            <tr></tr>
            <tr className="table_row">
              <td rowSpan={2}>
                <div>
                  <img className="table_img social_img" src={s12} alt="" />
                </div>
              </td>
            </tr>
            <tr></tr>
            <tr className="table_row">
              <td rowSpan={2}>
                <div>
                  <img className="table_img social_img" src={s7} alt="" />
                </div>
              </td>
            </tr>
            <tr></tr>
            <tr className="table_row">
              <td rowSpan={2}>
                <div>
                  <img className="table_img social_img" src={s1} alt="" />
                </div>
              </td>
            </tr>
            <tr></tr>
            <tr className="table_row">
              <td rowSpan={2}>
                <div>
                  <img className="table_img social_img" src={s4} alt="" />
                </div>
              </td>
            </tr>
            <tr></tr>
